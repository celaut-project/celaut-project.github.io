...
export default {
	glossary: {
		...
		terms: [
			...
			{
				// isolation
				match: ['isolamento', 'isolado', 'isolada', 'isolados', 'isoladas'],
				title: 'Isolamento',
			...
			{
				// sealed
				match: ['selado', 'selada', 'selados', 'seladas'],
				title: 'Selado',
				body: 'Fechado nos dois sentidos: o programa não vê a máquina em que está, e a máquina não pode olhar para dentro do programa.',
				more: 'No Celaut é o contrato entre um nó e um serviço: cada um é opaco para o outro.'
			},
			{
				// deterministic
			...
			{
				// specification
				match: ['especificação', 'especificações', 'especificado'],
				title: 'Especificação',
			...
			{
				// content-addressed
				match: ['endereçado por conteúdo', 'endereçada por conteúdo'],
			...
			},
			{
				...
				match: ['BOX'],
				title: 'BOX',
				body: 'A descrição escrita completa do ambiente de que um programa precisa para correr — tipo de processador, cada ficheiro, as definições, onde começa. Não um ponteiro para um pacote noutro sítio: o ambiente em si, listado.',
				more: 'Uma das três partes de um serviço Celaut, com API e NET. Como os ficheiros estão listados em vez de descarregados, não há um registo de imagens que possa desaparecer por baixo.'
			},
			{
				// net
				match: ['NET'],
