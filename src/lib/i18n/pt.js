...
export default {
	...
	home: {
		...
		scenes: {
			...
			'core-principles': {
				label: 'As regras que sustenta',
				beats: [
					{
						h: 'Nada disso era uma lista de funcionalidades.',
						p: 'Uma rede sem protocolo a acordar, serviços selados perante as máquinas que os executam, redes declaradas à partida, pagamento antes da execução: cada uma dessas coisas é uma <strong>consequência</strong>. Três compromissos as produzem, e sustentam-se uns aos outros.'
					},
					{
						h: 'Descentralização.',
						p: 'Nenhum <strong>ponto único de controlo ou de falha</strong>. Os nós comunicam e coordenam-se dinamicamente, sem nada no meio a quem pedir permissão — que é precisamente por isso que não havia protocolo nenhum a acordar.'
					},
					{
						h: 'Simplicidade.',
						p: '<strong>Regras minimalistas</strong> que reduzem a complexidade, de modo que cada componente permanece pequeno o suficiente para ser compreendido e mantido isoladamente. Um serviço é um contentor, uma interface e um âmbito de rede, e é tudo.'
					},
					{
						h: 'Determinismo.',
						p: 'Os serviços são especificados de forma completa o suficiente para <strong>reproduzir os seus resultados</strong> ao longo do tempo e entre máquinas. Mesmas entradas, mesmas saídas, onde e quando quer que corram — é isso que faz com que uma reputação registada há um ano ainda valha a pena ler hoje.',
						note: 'Tira qualquer um dos três e os outros dois deixam de valer grande coisa.'
					}
				]
			}
		},
		...
		implementations: {
			...
			intro: 'A arquitetura é uma especificação, e qualquer pessoa pode implementar um nó contra ela. Uma implementação faz a rede funcionar agora; a segunda é uma direção anunciada, e está assinalada como tal.',
			items: [
				{
					name: 'Nodo',
					stage: 'A funcionar',
				...
				},
				{
					name: 'Chatui',
					stage: 'Conceito',
					body: 'A intenção declarada de construir um nó Android que alcance serviços através de uma interface de chat simples, sem confiar em nenhum outro nó. O repositório contém hoje essa descrição e nada mais — ainda não há código para correr.'
				}
			],
			note: 'Nada aqui é um marcador de posição para algo que já funciona noutro sítio. O que funciona, funciona; o que não funciona, di-lo.'
		},
		applications: {
			eyebrow: 'Onde já está funcionando',
			heading: 'Impacto e aplicações no mundo real',
			intro: 'A arquitetura não é uma experiência mental. Está em uso a duas distâncias diferentes — como a camada em si, e como alicerce de algo com a sua própria razão de existir.',
			layerHeading: 'A arquitetura, ligada',
			layerTag: 'A própria camada',
			layerIntro: 'Nenhuma das duas é uma aplicação construída sobre Celaut. São o que Celaut <strong>é</strong>, assim que há nós realmente a funcionar.',
			layer: [
				{
					name: 'DePIN',
					body: 'Qualquer pessoa pode correr um nó Celaut e passar a fazer parte de uma rede de infraestrutura física descentralizada. Cada nó descobre pares, executa e orquestra serviços, e gere as suas dependências — transformando computadores comuns em computação partilhada e resistente à censura. Isto é a rede, não um produto sobre ela.'
				},
				{
					name: 'Unstoppable Skills',
					body: 'Um registo totalmente on-chain e sem servidores onde os protagonistas são os problemas. Em vez de procurar serviços, os agentes procuram uma competência e descobrem os serviços que a cobrem, com benchmarks reais e classificação por reputação. É como se alcança na prática a camada de reputação do paradigma — sobre Ergo, com verdadeiro risco próprio: ninguém faz spam sem arriscar a sua reputação.'
				}
			],
			builtOnHeading: 'Construído por cima',
			builtOnTag: 'Projeto independente',
			builtOnIntro: 'Um passo mais além: um produto com o seu próprio propósito e os seus próprios utilizadores, que por acaso é montado a partir de serviços Celaut. Continuaria a fazer sentido se fosse reconstruído sobre outra coisa — e é exatamente isso que o torna uma prova.',
			builtOn: {
	...
	depin: {
		meta: {
			...
			description: 'Venda os recursos do seu computador quando você não os estiver usando. A camada DePIN do Celaut é totalmente ponto a ponto, permite precificar a computação considerando seu custo de energia, e isola cada carga de trabalho dentro de uma microVM.'
		},
		...
		index: {
			sections: {
				rent: 'A ideia',
				p2p: 'Peer-to-peer',
				electricity: 'A tua fatura da luz',
				isolation: 'Isolamento',
				payoff: 'O que ganhas',
				responsibilities: 'O que faz um nó',
				steps: 'Da instalação ao rendimento',
				roles: 'O outro lado',
				cta: 'Começar'
			}
		},
		hero: {
			...
			actions: [
				'Comece a alugar seu PC',
				'Veja como funciona'
			],
			stats: [
				{
					value: '100%',
					label: 'totalmente ponto a ponto — nenhuma empresa no meio'
				},
				{
					value: 'Você',
					label: 'define o preço, considerando sua conta de energia'
				},
				{
					value: 'microVM',
					label: 'isolamento para cada carga de trabalho que você hospeda'
				}
			]
		},
		scenes: {
		...
		responsibilities: {
			heading: 'O que o nó na tua máquina faz realmente',
			intro: 'Um nó é um <strong>computador ou dispositivo</strong> que comunica com os seus pares e gere a execução de serviços. O paradigma atribui-lhe quatro tarefas, e não coloca nenhum coordenador acima dele.',
			items: [
				{
			...
			note: 'Nada disso exige saber para que serve o software que executa.'
		},
		steps: {
	...
	developers: {
		meta: {
			...
			description: 'Crie serviços Celaut: defina um BOX, uma API e um escopo NET, entregue-os a um nó, e deixe a rede distribuir e executar tudo. Sem infraestrutura, sem configuração, sem plataforma no meio.'
		},
		topbarTitle: 'Para desenvolvedores',
		index: {
			sections: {
				spec: 'A ideia',
				agnostic: 'Corre em qualquer lado',
				distribute: 'Distribuição',
				compose: 'Composição',
				payoff: 'O que ganhas',
				distribution: 'Como se propaga',
				steps: 'Do código à rede',
				tradeoffs: 'A troca',
				roles: 'Os outros',
				cta: 'Começar'
			}
		...
		hero: {
			...
			stats: [
				{
					value: 'BOX · API · NET',
					label: 'três componentes — essa é toda a especificação'
				},
				{
					value: 'Sem DevOps',
					label: 'os nós cuidam da execução; nenhuma conta na nuvem a abrir'
				},
				{
					value: 'Determinístico',
					label: 'mesmas entradas, mesmas saídas, em qualquer nó, a qualquer momento'
				}
			]
		},
		scenes: {
		...
		distribution: {
			heading: 'Como um serviço se propaga realmente',
			intro: 'Não há loja onde publicar nem revisão pela qual esperar. Um serviço é entregue a um nó, e a rede leva-o a partir daí — por omissão fora da cadeia, e opcionalmente nela.',
			items: [
				{
					title: 'Peer-to-peer por omissão',
				...
				{
					title: 'Num registo, se o merecer',
	...
	users: {
		meta: {
			...
			description: 'Execute serviços em nós Celaut e pague apenas pelos recursos computacionais utilizados. Sem contas, sem assinaturas, sem plataforma no meio — os serviços rodam de forma isolada e determinística, então você recebe exatamente o que a especificação descreve.'
		},
		...
		hero: {
			...
			stats: [
				{
					value: 'Sem conta',
					label: 'nada para se cadastrar, nada de onde você possa ser bloqueado'
				},
				{
					value: 'Por execução',
					label: 'você paga apenas pelos recursos computacionais realmente usados'
				},
				{
					value: 'Isolado',
					label: 'os serviços rodam lacrados e não veem nada que não lhes foi dado'
				}
			]
		},
		scenes: {
	...
	paradigm: {
		meta: {
			...
			description: 'Celaut: uma arquitetura ponto a ponto para o design e a distribuição de software — o artigo formal.'
		},
	 ...
	 */
	glossary: {
		hint: 'Alguma palavra que você não conhece? As que têm sublinhado pontilhado se explicam sozinhas: passe o mouse ou toque.',
		hintDismiss: 'Entendi',
		close: 'Fechar',
		terms: {
			p2p: {
				term: 'Peer-to-peer (entre pares)',
				body: 'Dois computadores tratando diretamente um com o outro, sem os servidores de nenhuma empresa no meio para encaminhar, aprovar ou ficar com uma parte do que passa entre eles.',
				analogy: 'Como pagar em dinheiro vivo em vez de fazer uma transferência: ninguém no meio precisa aprovar, e ninguém pode recusar.',
				match: ['peer-to-peer', 'ponto a ponto', 'P2P']
			},
			compute: {
				term: 'Computação',
				body: 'O trabalho bruto que um computador faz: tempo de processador, memória e disco. É o que você realmente compra ao alugar um servidor, e o que venderia aqui.',
				analogy: 'Eletricidade para programas: medida enquanto é usada e paga por unidade.',
				match: ['recursos computacionais', 'poder computacional', 'computação']
			},
			node: {
				term: 'Nó',
				body: 'Um computador que participa da rede: um notebook, um desktop, uma máquina parada num armário. Ele roda o software do Celaut e conversa com os outros que também o rodam.',
				analogy: 'Como um telefone numa rede telefônica: serve porque os outros existem, e nenhum manda nos demais.',
				match: ['nós', 'nó']
			},
			service: {
				term: 'Serviço',
				body: 'Um programa empacotado para que qualquer máquina o execute e obtenha exatamente o mesmo resultado. Você o pede pelo trabalho que faz, não pela empresa ou pelo servidor que o executa.',
				analogy: 'Como pedir um prato em vez de reservar uma cozinha específica.',
				match: ['serviços', 'serviço']
			},
			microvm: {
				term: 'microVM',
				body: 'Um computador pequeno e descartável criado dentro de um real, com seu próprio sistema operacional. O que roda lá dentro não enxerga a máquina que o hospeda, e é destruído quando o trabalho termina.',
				analogy: 'Uma cabine lacrada montada na sua casa para uma única visita: dá para trabalhar dentro dela e nunca ver outro cômodo.',
				match: ['microVMs', 'microVM']
			},
			container: {
				term: 'Contêiner',
				body: 'Um jeito de empacotar um programa junto com tudo de que ele precisa, para rodar igual em qualquer lugar. Mais leve que uma microVM, mas toma emprestado o sistema base da máquina anfitriã em vez de ter o seu.',
				analogy: 'Um prato congelado que viaja com a própria bandeja, mas ainda assim assa no seu forno.',
				match: ['contêineres', 'contêiner', 'containers', 'container']
			},
			kernel: {
				term: 'Kernel (núcleo)',
				body: 'A parte mais interna de um sistema operacional: o código que reparte o processador, a memória e o disco entre todo o resto. Programas que compartilham um kernel compartilham um único ponto de falha.',
				analogy: 'O zelador que guarda todas as chaves do prédio. Dois prédios, dois zeladores: nenhum abre as portas do outro.',
				match: ['kernels', 'kernel', 'núcleo']
			},
			contentAddressed: {
				term: 'Endereçado por conteúdo',
				body: 'Software identificado por uma impressão digital calculada a partir de exatamente o que há dentro dele, e não por um nome que alguém possa reapontar em silêncio. Mude um caractere e a impressão muda.',
				analogy: 'Pedir um livro pela impressão digital de todas as suas palavras, e não pelo título: uma cópia trocada não passa por original.',
				match: [
					'endereçado por conteúdo',
					'endereçados por conteúdo',
					'endereçamento por conteúdo'
				]
			},
			depin: {
				term: 'DePIN',
				body: 'Rede de Infraestrutura Física Descentralizada: hardware comum, de gente comum, reunido para fazer o trabalho dos datacenters de uma empresa.',
				analogy: 'Como os quartos vagos de uma cidade, que somados dão mais camas do que qualquer rede de hotéis.',
				match: ['DePIN']
			},
			reputation: {
				term: 'Reputação',
				body: 'Um registro público e permanente de se uma máquina cumpriu o que prometeu. Sem nenhuma empresa por trás do acordo, é o que torna seguro comprar da máquina de um desconhecido.',
				analogy: 'Como o prestígio de uma banca de feira entre seus fregueses, só que este registro não pode ser editado, apagado nem comprado.',
				match: ['reputação']
			},
			ergo: {
				term: 'Ergo (ERG)',
				body: 'A blockchain na qual o Celaut liquida os pagamentos, e ERG a moeda em que eles são liquidados. Os dois lados leem o mesmo livro-caixa compartilhado, então nenhum precisa confiar no outro.',
				analogy: 'Uma caixa registradora que comprador e vendedor conseguem ler e que não pertence a nenhum dos dois.',
				match: ['Ergo', 'ERG']
			},
			deterministic: {
				term: 'Determinístico',
				body: 'A mesma entrada dá o mesmo resultado, sempre e em qualquer máquina. É o que permite que outra pessoa repita o trabalho e confira que a resposta entregue é a certa.',
				analogy: 'Uma receita tão exata que dois cozinheiros em duas cozinhas não conseguem produzir bolos diferentes.',
				match: ['determinístic*', 'determinis*']
			},
			workload: {
				term: 'Carga de trabalho',
				body: 'Uma tarefa entregue a uma máquina: um programa que roda pelo tempo que for preciso, e nada mais. Quando termina, não deixa nada para trás.',
				analogy: 'Um único trabalho sobre a bancada, recolhido assim que fica pronto.',
				match: ['cargas de trabalho', 'carga de trabalho']
			},
			api: {
				term: 'API',
				body: 'A lista combinada de pedidos que um programa atende e do que ele devolve. É como dois programas trabalham juntos sem que nenhum saiba como o outro é construído por dentro.',
				analogy: 'Um cardápio: você pede o que está na lista e não entra na cozinha.',
				match: ['APIs', 'API']
			},
			orchestration: {
				term: 'Orquestração',
				body: 'Decidir qual máquina roda cada pedaço de trabalho e quando, e garantir que as peças se encontrem. Na maioria das nuvens um sistema central faz isso; aqui cada máquina se orquestra sozinha.',
				analogy: 'Um maestro mantendo a orquestra unida, só que aqui cada músico marca o tempo por conta própria.',
				match: ['orquestração', 'orquestrar', 'orquestram', 'orquestra']
			},
			sla: {
				term: 'SLA',
				body: 'Acordo de Nível de Serviço: a promessa escrita de um provedor sobre quanto tempo o serviço ficará no ar e com que velocidade, com dinheiro de volta se falhar. Uma promessa em que é preciso confiar — e que é preciso cobrar.',
				analogy: 'Um certificado de garantia: vale exatamente o que valer a empresa que o assinou.',
				match: ['SLAs', 'SLA']
			}
		}
	},
	...
	viz: {
		home: {
			...
			principles: {
				consequences: [
					'→ nenhum protocolo a acordar',
					'→ um contentor, uma interface, um âmbito',
					'→ reputação que mantém o seu sentido'
				],
				derivedFrom: 'tudo o resto deriva daqui'
			},
