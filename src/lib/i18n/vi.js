	...
	glossary: {
		...
		terms: [
			...
			},
			{
				...
				match: ['niêm phong'],
				title: 'Niêm phong',
				body: 'Đóng cả hai chiều: chương trình không thấy máy nó đang ngồi, và máy không thể nhìn vào trong chương trình.',
				more: 'Trong Celaut đó là hợp đồng giữa node và service: mỗi bên mờ đục với bên kia.'
			},
			{
				// deterministic
			...
			},
			{
				...
				match: ['BOX'],
				title: 'BOX',
				body: 'Mô tả viết đủ môi trường một chương trình cần để chạy — loại bộ xử lý, từng tệp, cấu hình, chỗ nó bắt đầu. Không phải con trỏ tới gói để nơi khác: chính môi trường, được liệt kê.',
				more: 'Một trong ba phần của service Celaut, cùng API và NET. Tệp được liệt kê chứ không tải về, nên không có kho ảnh nào biến mất bên dưới.'
			},
			{
				// net
				match: ['NET'],
