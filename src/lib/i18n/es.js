	...
	glossary: {
		...
		"terms": [
			...
			},
			{
				...
				"title": "Interfaz (API)",
				"body": "La forma definida de pedirle algo a un programa y recibir una respuesta. Es como un menú: indica qué puedes solicitar sin tener que conocer cómo se prepara por dentro."
			},
			{
				"match": [
					"especificación",
			...
			},
			{
				...
				"title": "Serverless",
				"body": "Una forma de utilizar software sin tener que administrar un servidor propio para cada tarea. Sigue habiendo ordenadores que ejecutan el trabajo, pero su gestión queda separada de quien lo solicita."
			},
			{
				"match": [
					"hard fork",
				...
				"title": "Hard fork (bifurcación incompatible)",
				"body": "Un cambio en las reglas de una red que no es compatible con las anteriores. Si algunos participantes mantienen las reglas antiguas, pueden formarse dos redes distintas.",
				"more": "Celaut busca evitar que todos tengan que adoptar a la vez un mismo cambio de protocolo."
			},
			{
				"match": [
					"Docker"
				...
				"title": "Docker",
				"body": "Una herramienta muy utilizada para empaquetar y ejecutar programas en contenedores. No es el nombre de un servicio de Celaut ni un requisito del paradigma."
			},
			{
				"match": [
					"gRPC"
				...
				"title": "gRPC",
				"body": "Una tecnología para que un programa solicite funciones a otro a través de una red. Es una opción de comunicación que una implementación puede sustituir por otra."
			}
		]
	},
