...
export default {
	...
	glossary: {
		...
		hintBody: 'Tap any underlined word for a plain-language explanation. Turn them off any time with the button in the corner.',
		hintDismiss: 'Got it',
		terms: [
			{
				// peer-to-peer
			...
			},
			{
				...
				match: ['sealed'],
				title: 'Sealed',
				body: 'Closed so that nothing crosses in either direction — the program cannot see the machine it is sitting on, and the machine cannot look inside the program.',
				more: 'In Celaut that is the contract between a node and a service: each is opaque to the other.'
			},
			{
				// deterministic
			...
			{
				// specification
				match: ['specification', 'specifications'],
				title: 'Specification',
			...
			{
				// content-addressed
				match: ['content-addressed', 'content addressed'],
			...
			{
				// blockchain
				match: ['blockchain', 'blockchains', 'on-chain'],
				title: 'Blockchain',
			...
			},
			{
				...
				match: ['BOX'],
				title: 'BOX',
				body: 'A complete written description of the environment a program needs in order to run — processor kind, every file, the settings, where it starts. Not a pointer to a package stored somewhere else: the environment itself, listed out.',
				more: 'One of three parts of a Celaut service, with API and NET. Because the files are listed rather than fetched, there is no image registry that can go missing underneath it.'
			},
			{
				// net
				match: ['NET'],
