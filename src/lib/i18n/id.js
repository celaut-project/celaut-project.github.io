...
export default {
	glossary: {
		...
		terms: [
			...
			{
				// isolation
				match: ['isolasi', 'terisolasi', 'tersandbox'],
				title: 'Isolasi',
			...
			},
			{
				...
				match: ['tersegel'],
				title: 'Tersegel',
				body: 'Tertutup dua arah: program tidak melihat mesin tempatnya berjalan, dan mesin tidak dapat melihat ke dalam program.',
				more: 'Di Celaut itu kontrak antara node dan service: masing-masing buram bagi yang lain.'
			},
			{
				// deterministic
			...
			},
			{
				...
				match: ['BOX'],
				title: 'BOX',
				body: 'Deskripsi tertulis lengkap lingkungan yang dibutuhkan program agar bisa berjalan — jenis prosesor, setiap berkas, pengaturan, di mana ia mulai. Bukan penunjuk ke paket yang disimpan di tempat lain: lingkungannya sendiri, didaftar.',
				more: 'Salah satu dari tiga bagian service Celaut, bersama API dan NET. Karena berkas didaftar bukan diunduh, tidak ada registri image yang bisa hilang di bawahnya.'
			},
			{
				// net
				match: ['NET'],
